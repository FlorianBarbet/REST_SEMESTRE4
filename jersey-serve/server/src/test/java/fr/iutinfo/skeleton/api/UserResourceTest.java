...
public class UserResourceTest extends JerseyTest {
    ...
    public void read_user_should_read_user_with_same_salt() {
        ...
        UserJobber user = dao.findByName("Mark Shuttleworth");
    ...
    public void read_user_should_return_hashed_password() throws NoSuchAlgorithmException {
        ...
        UserJobber user = dao.findByName("Loïc Dachary");
    ...
    public void create_should_return_the_user_with_valid_id() {
        UserJobber user = new UserJobber(0, "thomas");
        Entity<UserJobber> userEntity = Entity.entity(user, MediaType.APPLICATION_JSON);
    ...
    public void after_delete_read_user_sould_return_204() {
        UserJobber u = createUserWithName("toto");
    ...
    public void should_delete_user() {
        ...
        UserJobber user = dao.findById(u.getId());
